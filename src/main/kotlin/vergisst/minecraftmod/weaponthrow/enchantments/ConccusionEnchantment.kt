...
class ConccusionEnchantment(rarity: Enchantment.Rarity, vararg slot: EquipmentSlot):
    Enchantment(rarity, EnchantmentTarget.WEAPON, slot) {

    override fun getMinPower(level: Int) = 30
    override fun getMaxPower(level: Int) = 60
    ...
    override fun isAcceptableItem(stack: ItemStack): Boolean {
        ...
        val isEnabled = ConfigRegistry.COMMON.config.enchantments.enableConccusion
