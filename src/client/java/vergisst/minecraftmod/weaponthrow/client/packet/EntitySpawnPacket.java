...
public class EntitySpawnPacket {
    public static Packet<?> create(Entity e) {
        ...
        return ServerPlayNetworking.createS2CPacket(PacketIdentifiers.SPAWN_PACKET, byteBuf);
    }
    ...
    public static void register() {
        ClientPlayNetworking.registerGlobalReceiver(PacketIdentifiers.SPAWN_PACKET, (client, handler, buf, responseSender) -> {
